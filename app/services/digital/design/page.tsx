        ...
        <main dir={lang === "ar" ? "rtl" : "ltr"} className="bg-background min-h-screen text-foreground">
            ...
            <PageSection title={t("services_pages.digital.design_details.overview_title")} columns={2}>
                ...
                <div className="relative aspect-video rounded-3xl overflow-hidden bg-secondary/50 border border-border flex items-center justify-center p-8">
                    <div className="w-full h-full relative border border-border rounded-2xl p-4 bg-secondary overflow-hidden">
                        <div className="absolute top-0 left-0 w-full h-8 border-b border-border flex items-center px-4 gap-2">
                            <div className="w-2 h-2 rounded-full bg-red-500/50" />
                            <div className="w-2 h-2 rounded-full bg-yellow-500/50" />
                            <div className="w-2 h-2 rounded-full bg-green-500/50" />
                        </div>
                        <div className="mt-8 grid grid-cols-2 gap-4">
                            <div className="h-24 rounded-lg bg-secondary border border-border animate-pulse" />
