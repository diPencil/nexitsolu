                ...
                <div className="flex flex-col justify-center">
                    ...
                    <div className="flex items-center gap-4 text-[#0066FF]">
                        ...
                        <span className="font-bold tracking-tight uppercase">
                            {t("services_pages.accelerators.cloud_details.badge")}
                        </span>
                    </div>
                </div>
                <div className="relative aspect-video rounded-3xl overflow-hidden bg-secondary/50 border border-border group shadow-2xl">
                    <Image
