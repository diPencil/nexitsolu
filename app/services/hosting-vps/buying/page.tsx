            ...
            <PageSection title={t("services_pages.hosting.buying_details.overview_title")} columns={2}>
                <div className="flex flex-col justify-center">
                    ...
                    <div className="flex items-center gap-4 text-[#0066FF]">
                        ...
                        <span className="font-bold tracking-tight uppercase">
                            {t("services_pages.hosting.buying_details.badge")}
                        </span>
                    </div>
                </div>
                <div className="relative aspect-video rounded-3xl overflow-hidden bg-secondary/50 border border-border flex items-center justify-center p-12">
                    <div className="flex flex-col items-center gap-6 w-full max-w-sm">
                        <div className="w-full h-12 rounded-xl bg-secondary border border-border flex items-center px-4 gap-3">
                            <Globe className="w-4 h-4 text-muted-foreground" />
                            <div className="text-muted-foreground text-sm">www.yourbrand.com</div>
                        ...
                        <div className="grid grid-cols-2 gap-4 w-full">
                            <div className="h-24 rounded-xl bg-[#0066FF]/5 border border-[#0066FF]/20 flex flex-col items-center justify-center gap-2">
                                ...
                                <span className="text-[10px] text-muted-foreground/70 uppercase">SSL Secure</span>
                            </div>
                            <div className="h-24 rounded-xl bg-green-500/5 border border-green-500/20 flex flex-col items-center justify-center gap-2">
                                ...
                                <span className="text-[10px] text-muted-foreground/70 uppercase">99.9% Uptime</span>
                            </div>
                        </div>
                    </div>
                </div>
