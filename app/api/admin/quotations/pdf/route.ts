...
export async function GET(req: NextRequest) {
    try {
        ...
        try {
            ...
            console.warn("Falling back to Helvetica for quotation PDF:", error);
        }
        ...
        if (fs.existsSync(fontBoldPath)) {
            try {
                ...
                console.warn("Falling back to Helvetica Bold for quotation PDF:", error);
            }
        }
        ...
        if (fs.existsSync(amiriPath)) {
            try {
                ...
                console.warn("Failed to embed Amiri font for quotation PDF:", error);
            }
        }
