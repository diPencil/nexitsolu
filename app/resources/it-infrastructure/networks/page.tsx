        ...
        <main dir={lang === "ar" ? "rtl" : "ltr"} className="bg-background min-h-screen text-foreground">
            ...
            <PageSection title={lang === "ar" ? "حلول الربط المتقدمة" : "Advanced Connectivity Solutions"} columns={3}>
                <div className="p-8 rounded-3xl bg-card border border-border">
                    ...
                    <p className="text-muted-foreground text-sm">{lang === "ar" ? "ربط كافة فروع شركتك بمنظومة واحدة." : "Connect all your company branches into one system."}</p>
                </div>
                <div className="p-8 rounded-3xl bg-card border border-border">
                    <Globe className="w-10 h-10 text-[#0066FF] mb-4" />
                    <h4 className="text-lg font-bold mb-2">{lang === "ar" ? "إدارة سحابية" : "Cloud Management"}</h4>
                    <p className="text-muted-foreground text-sm">{lang === "ar" ? "تحكم كامل في شبكتك من أي مكان." : "Full control over your network from anywhere."}</p>
                </div>
                <div className="p-8 rounded-3xl bg-card border border-border">
                    ...
                    <p className="text-muted-foreground text-sm">{lang === "ar" ? "أعلى معايير الأمان السيبراني." : "Highest standards of cybersecurity."}</p>
                </div>
            </PageSection>
