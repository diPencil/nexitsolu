        ...
        <main dir={lang === "ar" ? "rtl" : "ltr"} className="bg-[#050505] min-h-screen text-white">
            ...
            <PageSection title={lang === "ar" ? "معايير التميز في التأسيس" : "Foundation Excellence Standards"} columns={3}>
                <div className="p-8 rounded-3xl bg-[#111111] border border-white/5">
                    ...
                    <p className="text-zinc-500 text-sm">{lang === "ar" ? "الالتزام بالمعايير العالمية للاتصالات." : "Adherence to international telecom standards."}</p>
                </div>
                <div className="p-8 rounded-3xl bg-[#111111] border border-white/5">
                    ...
                    <p className="text-zinc-500 text-sm">{lang === "ar" ? "نضمن جودة التوصيل وكفاءة الأسلاك." : "Guaranteeing cabling quality and efficiency."}</p>
                </div>
                <div className="p-8 rounded-3xl bg-[#111111] border border-white/5">
                    ...
                    <p className="text-zinc-500 text-sm">{lang === "ar" ? "تقديم خرائط كاملة للبنية التحتية." : "Providing full infrastructure maps."}</p>
                </div>
            </PageSection>
